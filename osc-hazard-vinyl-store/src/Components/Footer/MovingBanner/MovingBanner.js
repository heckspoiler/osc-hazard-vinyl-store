...
export const MovingBanner = () => {
  return (
    <div className="moving-banner-container relative w-[200%] overflow-hidden h-6 w-full bg-violet flex flex-row justify-between items-center border border-y-black">
      <div className="w-[200%] flex items-center h-20 justify-between gap-40 absolute left-0 animate animate">
        {contentArray.map((i) => {
          return (
