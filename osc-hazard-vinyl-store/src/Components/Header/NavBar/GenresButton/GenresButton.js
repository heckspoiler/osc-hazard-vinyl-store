...
export const GenresButton = ({ title, links }) => {
  ...
  return (
    <li
      className="list-item rounded-3xl font-inter hover:bg-white tracking-wider h-auto w-auto p-3 border-bottom-width transition-all duration-200 ease-in-out flex px-4 justify-center align-center text-xxs hover:bg-violet-300 border border-transparent hover:border-black "
